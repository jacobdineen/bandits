...
from lib.TSMultiArmedBandit import ThompsonSamplingMultiArmedBandit
from lib.TSLinearBandit import ThompsonSamplingLinearBandit

from lib.PHEMultiArmedBandit import PerturbedHistoryExplorationMultiArmedBandit
from lib.PHELinearBandit import PerturbedHistoryExplorationLinearBandit
...
if __name__ == '__main__':
	...
	# algorithms['PHEMultiArmedBandit'] = PerturbedHistoryExplorationMultiArmedBandit(num_arm=n_articles, epsilon=None, alpha = 2, sigma = NoiseScale)
	# algorithms['PHELinearBandit'] = PerturbedHistoryExplorationLinearBandit(dimension=context_dimension, lambda_=0.1, epsilon=None, alpha = 2, sigma = NoiseScale)
